function y = morfoloji02(resimOKU)
...
se = strel('disk',1); % yapýsal element oluþturuldu (yarýçapý 1 olan bir dairesel þekil oluþturduk. beyaz alanlarýmýzý birbirinden ayýrdýk) 
